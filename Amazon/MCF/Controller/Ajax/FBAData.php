...
class FBAData extends \Magento\Framework\App\Action\Action {
    ...
    public function __construct(
        ...
        $this->_storeManager = $om->get('Magento\Store\Model\StoreManagerInterface');
    ...
    public function execute() {
        ...
        if ($params && isset($params['pcode']) && $params['pcode'] && isset($params['pid'])
            ...
            $address = [
                'CountryCode' => $this->_helperData->getStoreCountry($storeId),
                'PostalCode' => $pcode,
                'City' => 'Placeholder',
                'Line1' => '100 main st',
                'Name' => 'john doe',
            ...
            if ($items) {
                $rates = $this->_outbound->getProductEstimate($address, $items);
